...
const HeroSection = () => {
  return (
    <section
      className='sm:w-[45%] w-[90%] bg-black text-white flex flex-col justify-center sm:flex-row sm:gap-5 gap-3 sm:p-8 p-6 rounded-lg sm:text-lg text-sm shadow-lg'
    >
      ...
      <div>
        <div className='space-y-1'>
          <h2 className='sm:text-lg text-xl font-semibold'>Ujjwal Kumar</h2>
